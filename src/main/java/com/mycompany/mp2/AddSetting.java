    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (discount == null) {
            try {
                ...
                String query = "update priceanddiscount set price=" + price + "";
                con = ConnectionClass.getConnection();
                ps = con.prepareStatement(query);
                ps.executeUpdate();
                con.close();
            ...
            try {
                int ogdiscount = Integer.parseInt(discount);
                String query = "update priceanddiscount set discount=" + ogdiscount + "";
                System.out.println(query);
                con = ConnectionClass.getConnection();
                ps = con.prepareStatement(query);
                ps.executeUpdate();
