    ...
    <body>
        <div class="site-wrap">
            <div class="container">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 text-md-center">
                        <div class="card text-center" >
                            <a class="btn btn-default  mt-3" id="prepaymentblock">No of Days Data to be maintained for orders
                                <div class="card-body ">
                                    <div class="input-group input-group-lg">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 text-md-center mt-3">
                        ...
                        <div class="card text-center" id="hidepassword">
                            <a class="btn btn-default mt-3" id="prepaymentblock">Provide Admin Password to change name & password
                                <div class="card-body ">
                                    <div class="input-group input-group-lg">
                    ...
                    <div class="col-lg-6 col-sm-12 col-md-6 text-md-center mt-3">
                        <div class="row">
                            ...
                            <div class="col-lg-6 text-md-center">
                                <div class="card text-center">
                                    <a class="btn btn-default mt-3" id="prepaymentblock">
                                        <h6>minimum Price Order</h6>
                                        <h6>Update($)</h6>
                                        <div class="card-body ">
                                            <div class="input-group input-group-lg">
                                                <input type="text" id="uprice"  class="form-control" />
                                            </div><!-- /input-group -->
                                        </div>
                                    </a>
                                    <button class="btn btn-danger" id="updateprice" >Update Price</button>
                                </div>
                            </div>
                            <div class="col-lg-6 text-md-center ">
                                <div class="card text-center">
                                    <a class="btn btn-default mt-3" id="prepaymentblock">
                                        Discount Giving Price($)
                                        <div class="card-body ">
                                            <div class="input-group input-group-lg">
                                    ...
                                    <button class="btn btn-danger" id="updatediscount" >Update Discount</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <script>
            ...
            document.getElementById("updateprice").addEventListener("click", function () {
                $('#spinjack').show();
                var up = document.getElementById("uprice").value;
                $.ajax({
                    url: 'AddSetting',
                    type: 'post',
                    data: {
            ...
            document.getElementById("updatediscount").addEventListener("click", function () {
                $('#spinjack').show();
                var ud = document.getElementById("discountprice").value;
                $.ajax({
                    url: 'AddSetting',
                    type: 'post',
                    data: {
