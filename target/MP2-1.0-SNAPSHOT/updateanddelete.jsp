    ...
    <body>
                            ...
                            <div class="tab-content">
                                <div id="home" class="container tab-pane active"><br>
                                    <div class="row">
                                        ...
                                        <form action="UpdateImageWithAjax" method="post" enctype="multipart/form-data">
                                            <div class="row text-center">
                                                <div class="form-group mb-3 p-1">
                                                    <input type="text" name="companyname" class="form-control" id="companyname" required="can't be null">
                                                </div>
                                                <div class="form-group mb-3 p-1">
                                                    <input type="text" name="genericname" class="form-control" id="genericname" required="can't be null" >
                                                </div>
                                                <div class="form-group mb-3 p-1">
                                        ...
                                        <form id="imgupdateform" enctype="multipart/form-data">
                                            <div class="col-6">
                                            ...
                                            <div class="form-group mb-3 p-1">
                                                <input type="text" name="brandname" class="form-control" id="brandname2" required="can't be null" >
                                            </div>
                                            <div class="form-group mb-3 p-1">
                                                <input type="text" name="companyname" class="form-control" id="companyname2" required="can't be null" >
                                            </div>
                                            <div class="col-6">
                                                <button id="updateImage" class="btn btn-primary">Update Image</button>
                                            </div>
                                        </form>
                                ...
                                <div id="menu1" class="container tab-pane fade"><br>
                                    ...
                                    <form id="cateform" action="myOrders" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div id="spinjack2" class="spinner-border text-dark mt-2"> 
                                            </div>
                                        </div>
        ...
        <script>
            ...
            $('#updateImage').click(function () {
                if ($('#companyname').val() !== null && $('#brandname').val() !== null) {
                    $('#spinjack2').show();
                    $('#imgupdateform').submit(function (event) {
                        event.preventDefault();
                        $.ajax({
                            url: 'updateImageProduct',
                            type: 'post',
                            data: new FormData(this),
                            contentType: false,
                            cache: false,
                ...
                $.get('UpdateandDelete', {subname: i, data: subvalue, tablename: subvalue}, function (responsivetext) {
                    if (responsivetext !== null) {
                        ...
                        $.each(responsivetext, function (key, value) {
                            ...
                            $('#companyname2').val(value.companyname);
                            $('#genericname').val(value.genericname);
                            $('#brandname').val(value.brandname);
                            $('#brandname2').val(value.brandname);
